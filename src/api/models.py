...
class Taller(db.Model):
    ...
    lat = db.Column(db.Float(precision=32, decimal_return_scale=None), unique=False, nullable=False)
    lng = db.Column(db.Float(precision=32, decimal_return_scale=None), unique=False, nullable=False)
